...
const subjects = [
  {
    ...
    topics: [
      makeTopic(
        ...
        [
          [
            'What section is the Language paper focused on?',
            'Section A',
            ['Section A', 'Section B', 'Coursework', 'Speaking exam'],
          ],
          [
            'What does Question 5 test?',
            'Comparison between the unseen and anthology text',
            [
              'Comparison between the unseen and anthology text',
              'Creative writing',
              'Spelling only',
          ...
          [
            'Which question is not in the End of Year?',
            'Question 4',
            ['Question 4', 'Question 1', 'Question 2', 'Question 5'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'What does AO3 focus on?',
            'Links between writers’ ideas and perspectives',
            [
              'Links between writers’ ideas and perspectives',
              'Only spelling',
              'Only punctuation',
          ...
          [
            ...
            'However',
            ['However', 'Similarly', 'Equally', 'Both'],
          ],
          [
            'What does PETAL help with?',
            'Paragraph structure',
            [
              'Paragraph structure',
      ...
      makeTopic(
        ...
        [
          [
            'What is the main danger Adichie warns about?',
            'Stereotypes from a single story',
            [
              'Stereotypes from a single story',
              'Reading too slowly',
              'Not travelling',
          ...
          [
            'What method does Adichie often use?',
            'Personal anecdote',
            [
              'Personal anecdote',
              'Rhyming couplets',
          ...
          [
            'What do many stories help to restore?',
            'Dignity',
            ['Dignity', 'Silence', 'Confusion', 'Jealousy'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'What is the text mainly connected to?',
            'Nature and control',
            [
              'Nature and control',
              'War photography',
          ...
          [
            'What should you analyse in this text?',
          ...
          [
            'What does the hawk often seem?',
            'Powerful',
            ['Powerful', 'Weak', 'Comic', 'Ordinary'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'Where is the writer reporting from?',
            'Somalia',
            ['Somalia', 'Nigeria', 'Bhutan', 'China'],
          ],
          [
            'What does the remembered smile make him question?',
          ...
          [
            ...
            'Human dignity',
            ['Human dignity', 'Romantic love', 'Jealousy', 'Sport'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'What type of writing is Chinese Cinderella?',
            'Autobiographical',
            ['Autobiographical', 'A poem', 'A play', 'A newspaper report'],
          ],
          [
            'Which theme fits the text?',
            'Childhood and unfairness',
            [
              'Childhood and unfairness',
              'War reporting',
              'Space travel',
          ...
          [
            'What should you track across the extract?',
            'How the writer’s feelings develop',
            [
              'How the writer’s feelings develop',
              'Only the first line',
              'Only the title',
      ...
      makeTopic(
        ...
        [
          [
            'Which idea is important in The Explorer’s Daughter?',
          ...
          [
            'What type of language is useful to analyse?',
            'Descriptive language',
            [
              'Descriptive language',
              'Only dialogue',
          ...
          [
            'What should comparison focus on?',
            'Writers’ attitudes',
            [
              'Writers’ attitudes',
              'Font size',
      ...
      makeTopic(
        ...
        [
          [
            'Where is the journey into?',
            'Bhutan',
            ['Bhutan', 'Somalia', 'Nigeria', 'England'],
          ],
          [
            'Which theme fits this text?',
            'Travel and changing perspective',
            [
              'Travel and changing perspective',
              'War trauma only',
              'Jealousy',
          ...
          [
            ...
            'How writers react to unfamiliar places',
            [
              'How writers react to unfamiliar places',
      ...
      makeTopic(
        ...
        [
          [
            'What is a key focus of Young and Dyslexic?',
            'Education and identity',
            ['Education and identity', 'War and famine', 'Marriage', 'A tiger'],
          ],
          [
            'Which idea links well to this text?',
            'Overcoming barriers',
            [
              'Overcoming barriers',
              'Romantic love',
    ...
    topics: [
      makeTopic(
        ...
        [
          [
            ...
            'The Duke',
            ['The Duke', 'The Duchess', 'A soldier', 'A photographer'],
          ],
          [
            'What form is the poem?',
            'Dramatic monologue',
            ['Dramatic monologue', 'Sonnet', 'Ballad', 'Free verse'],
          ],
          [
            'Which theme is strongest in the poem?',
            'Power and control',
            ['Power and control', 'Nature', 'Childhood', 'Comedy'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'What is the poem mainly questioning?',
            'Who created the tiger',
            [
              'Who created the tiger',
              'Where the tiger lives',
              'How to hunt the tiger',
              'Why the tiger is asleep',
            ],
          ],
          [
            'Which theme fits The Tyger best?',
            'Power and mystery',
            ['Power and mystery', 'Romantic love', 'War guilt', 'Old age'],
          ],
          [
            'What does repeated questioning create?',
            'Uncertainty',
            ['Uncertainty', 'A clear answer', 'A comic mood', 'A simple story'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'Who is the central male figure?',
            'A knight',
            ['A knight', 'A duke', 'A photographer', 'A priest'],
          ],
          [
            'What form does the poem use?',
            'Ballad',
            ['Ballad', 'Sonnet', 'Dramatic monologue', 'Haiku'],
          ],
          [
            'What mood best fits the poem?',
            'Haunting',
            ['Haunting', 'Cheerful', 'Relaxed', 'Comic'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          ...
          [
            'Which contrast is important in the poem?',
            'Safety and war',
            [
              'Safety and war',
              'Summer and winter',
      ...
      makeTopic(
        ...
        [
          [
            ...
            'An unborn child',
            ['An unborn child', 'A duke', 'A knight', 'A photographer'],
          ],
          [
            'What does repetition create?',
            'Urgency',
            ['Urgency', 'Comedy', 'Certainty', 'Silence'],
          ],
          [
            'Which theme fits the poem?',
            'Fear of human cruelty',
            [
              'Fear of human cruelty',
      ...
      makeTopic(
        ...
        [
          ...
          [
            'What form is Sonnet 116?',
            'Sonnet',
            ['Sonnet', 'Ballad', 'Dramatic monologue', 'Epic'],
          ],
          [
            'What does the poem say true love does?',
            'It stays constant',
            [
              'It stays constant',
  ...
  },
  {
    ...
    category: 'Year 10',
    description:
      'Year 10 Geography — coasts, hazards, urban environments, economic activity and human fieldwork.',
    topics: [
      makeTopic(
        'geo-exam-overview',
        'Geography EOY Exam Overview',
        'Foundation Forge',
        'Not forged',
        [
          'The Geography End of Year exam is worth 90 marks and lasts 1 hour 30 minutes.',
          'There is a separate resource booklet with the question paper.',
          'You answer all questions. There is no choice in the paper.',
          'The paper has four sections: Coasts, Hazards, Urban and Economic Activity, and Human Fieldwork.',
          'Bring a ruler and calculator because the paper can include map, graph and data questions.',
        ],
        [
          [
            'How many marks is the Geography EOY exam worth?',
            '90 marks',
            ['90 marks', '60 marks', '75 marks', '100 marks'],
          ],
          [
            'How long is the normal Geography EOY exam?',
            '1 hour 30 minutes',
            ['1 hour 30 minutes', '45 minutes', '2 hours', '1 hour'],
          ],
          [
            'How many main sections are in the Geography EOY paper?',
            'Four',
            ['Four', 'Two', 'Six', 'One'],
          ],
        ]
      ...
      makeTopic(
        'geo-coastal-processes',
        'Coastal Processes',
        'Foundation Forge',
        'Not forged',
        [
          'Marine processes include erosion, transportation, deposition and wave action.',
          'Constructive waves build beaches because swash is stronger than backwash.',
          'Destructive waves erode beaches because backwash is stronger than swash.',
          'Erosion includes hydraulic action, abrasion, attrition and solution.',
          'Transportation includes traction, saltation, suspension and solution.',
        ],
        [
          [
            'Which type of wave usually builds beaches?',
            'Constructive waves',
            [
              'Constructive waves',
              'Destructive waves',
          ...
          [
            ...
            'Erosion caused by water and air forced into cracks',
            [
              'Erosion caused by water and air forced into cracks',
              'Pebbles hitting each other',
              'Material moving in solution',
              'Sand being deposited',
            ],
          ],
          [
            'What is longshore drift?',
            'Transport of sediment along the coast by swash and backwash',
            [
              'Transport of sediment along the coast by swash and backwash',
      ...
      makeTopic(
        'geo-sub-aerial-processes',
        'Weathering and Mass Movement',
        'Steel Forge',
        'Not forged',
        [
          'Sub-aerial processes happen on land but affect the coast.',
          'Mechanical weathering breaks rock apart without changing its chemical structure.',
          'Chemical weathering breaks rock down through chemical reactions, such as carbonation.',
          'Biological weathering is caused by living things such as plant roots and animal burrowing.',
          'Mass movement includes sliding, slumping and rock fall.',
        ],
        [
          [
          ...
          [
            'Which one is a type of mass movement?',
            'Slumping',
            ['Slumping', 'Solution', 'Suspension', 'Swash'],
          ],
        ]
      ),
      makeTopic(
        'geo-coastal-landforms',
        'Coastal Landforms',
        'Steel Forge',
        'Not forged',
        [
          'Headlands and bays form where bands of hard and soft rock erode at different rates.',
          'Wave-cut platforms form when erosion undercuts a cliff and the cliff retreats over time.',
          'Caves, arches, stacks and stumps form by erosion along weaknesses in headlands.',
          'Beaches form by deposition of sediment in low-energy environments.',
          'Spits form when longshore drift carries material across a river mouth or bay.',
        ],
        [
          [
          ...
          [
            'What forms after an arch collapses?',
            'Stack',
            ['Stack', 'Bay', 'Fjord', 'Sand dune'],
          ],
          [
            'Which process mainly builds beaches?',
            'Deposition',
            ['Deposition', 'Hydraulic action', 'Abrasion', 'Carbonation'],
          ],
        ]
      ),
      makeTopic(
        'geo-coastal-ecosystems',
        'Coastal Ecosystems',
        'Iron Forge',
        'Not forged',
        [
          'Coastal ecosystems include coral reefs, mangroves, sand dunes and salt marshes.',
          'Abiotic characteristics are non-living features such as temperature, water, light and soil.',
          'Biotic characteristics are living features such as plants, animals and food webs.',
          'Coastal ecosystems can be threatened by industry, agriculture, tourism and deforestation.',
          'A named coastal ecosystem can be used to explain how living and non-living factors interact.',
        ],
        [
          [
            'Which one is a coastal ecosystem?',
            'Mangrove',
            ['Mangrove', 'Hotspot', 'CBD', 'Epicentre'],
          ],
          [
            'What does abiotic mean?',
            'Non-living',
            ['Non-living', 'Living', 'Economic', 'Urban'],
          ],
          [
            'Which human activity can threaten coastal ecosystems?',
            'Tourism',
            ['Tourism', 'Swash', 'Saltation', 'Subduction'],
          ],
        ]
      ),
      makeTopic(
        'geo-hazard-basics',
        'Hazard Characteristics and Distribution',
        'Foundation Forge',
        'Not forged',
        [
          'Natural hazards include earthquakes, volcanoes and tropical cyclones.',
          'The distribution of volcanoes and earthquakes is strongly linked to plate boundaries.',
          'Volcanoes can be measured using eruption size and explosivity.',
          'Earthquakes are measured using magnitude and intensity.',
          'Tropical cyclones are measured using wind speed and storm intensity scales.',
        ],
        [
          [
            'Which hazards are strongly linked to plate boundaries?',
          ...
          [
            'Which hazard needs warm ocean water?',
            'Tropical cyclone',
            ['Tropical cyclone', 'Earthquake', 'Volcano', 'Rock fall'],
          ],
        ]
      ),
      makeTopic(
        'geo-tectonic-hazards',
        'Earthquakes and Volcanoes',
        'Iron Forge',
        'Not forged',
        [
          'Earthquakes happen when pressure builds and is suddenly released along faults or plate boundaries.',
          'Volcanoes form where magma reaches the surface, often at plate boundaries or hotspots.',
          'Destructive margins can produce violent volcanoes and powerful earthquakes.',
          'Constructive margins can produce volcanic activity as plates move apart.',
          'Hotspots can create volcanoes away from plate boundaries.',
        ],
        [
          [
            'What is released during an earthquake?',
            'Built-up pressure or energy',
            [
              'Built-up pressure or energy',
              'Longshore drift',
              'Urban land value',
          ...
          [
            ...
            'Plate boundaries',
            ['Plate boundaries', 'CBDs', 'Spits', 'Transects'],
          ],
          [
            'What can create volcanoes away from plate boundaries?',
            'Hotspots',
            [
              'Hotspots',
      ...
      makeTopic(
        'geo-tropical-cyclones',
        'Tropical Cyclones',
        'Iron Forge',
        'Not forged',
        [
          'Tropical cyclones form over warm ocean water, usually above 27°C.',
          'Low atmospheric pressure helps air rise and create storm conditions.',
          'The Coriolis force helps storms rotate.',
          'Low wind shear allows the storm structure to remain organised.',
          'Tropical cyclones can cause strong winds, heavy rain, storm surges and flooding.',
        ],
        [
          [
            'What ocean temperature is usually needed for tropical cyclones?',
            'Above 27°C',
            ['Above 27°C', 'Below 0°C', 'Exactly 10°C', 'Any temperature'],
          ],
          [
            'What force helps tropical cyclones rotate?',
            'Coriolis force',
            [
              'Coriolis force',
              'Longshore drift',
          ...
          [
            'Which impact can tropical cyclones cause?',
            'Storm surges',
            [
              'Storm surges',
              'Raised beaches only',
              'Counter-urbanisation only',
              'Greenfield debate only',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        'Not forged',
        [
          'People continue to live in hazardous areas because of jobs, family, farming, resources and the belief that events are rare.',
          'Countries are vulnerable in different ways: physically, socially and economically.',
          'Short-term impacts happen immediately after a hazard, such as deaths, injuries and building damage.',
          'Long-term impacts last longer, such as rebuilding costs, disease, homelessness and economic disruption.',
          'A good answer compares how impact changes depending on development, preparation and response.',
        ],
        [
          [
            'Why might people stay in hazardous areas?',
            'Jobs and family links',
            [
              'Jobs and family links',
              'Because hazards never happen',
              'Because there are no risks',
              'Because maps are banned',
            ],
          ],
          [
            'Which is a short-term hazard impact?',
            'Injuries',
            [
              'Injuries',
              'Long-term rebuilding debt',
              'Changing employment structure',
              'Counter-urbanisation',
            ],
          ],
          [
            'Which type of vulnerability is linked to wealth and resources?',
            'Economic vulnerability',
            [
              'Economic vulnerability',
              'Wave action',
              'Abiotic vulnerability',
              'Transect vulnerability',
            ],
          ],
        ]
      ),
      makeTopic(
        'geo-earthquake-management',
        'Earthquake Management',
        'Gold Forge',
        'Not forged',
        [
          'Earthquake preparation includes warning, evacuation, building design, remote sensing and GIS.',
          'Short-term responses include emergency aid, shelter and supplies.',
          'Long-term planning includes risk assessment, hazard mapping and rebuilding programmes.',
          'A developed country may manage earthquakes differently from a developing or emerging country.',
          'Good case study answers separate preparation, immediate response and long-term recovery.',
        ],
        [
          [
            'Which technology can help map earthquake risk?',
            'GIS',
            ['GIS', 'Swash', 'Abrasion', 'CBD'],
          ],
          [
            'Which one is a short-term response after an earthquake?',
            'Emergency aid',
            [
              'Emergency aid',
          ...
          [
            'Which one is long-term planning?',
            'Hazard mapping',
            [
              'Hazard mapping',
      ...
      makeTopic(
        ...
        'Not forged',
        [
          'Urbanisation is the increasing percentage of people living in urban areas.',
          'Suburbanisation is movement from inner city areas to suburbs.',
          'Counter-urbanisation is movement from urban areas to rural areas.',
          'Megacities grow because of natural increase and rural to urban migration.',
          'Rapid urbanisation can create congestion, transport pressure, unemployment, crime and environmental issues.',
        ],
        [
          [
            ...
            [
              'Increasing percentage of people living in urban areas',
              'Movement of waves along a beach',
          ...
          [
            ...
            [
              ...
              'Movement of plates together',
              'Movement of sediment along the beach',
            ],
          ],
          [
            'Which problem is linked to rapid urbanisation?',
            'Congestion',
            [
              'Congestion',
              'Hydraulic action',
      ...
      makeTopic(
        'geo-urban-land-use',
        'Urban Land Use and Challenges',
        'Steel Forge',
        'Not forged',
        [
          'Urban land use patterns are affected by locational needs, accessibility and land values.',
          'Developed country cities can face food, energy, transport and waste disposal demands.',
          'Concentrated resource consumption can create pressure on services and infrastructure.',
          'Segregation can happen when different social or economic groups are separated within a city.',
          'Urban challenge questions often need a named developed country example.',
        ],
        [
          [
            'Which factor affects urban land use?',
            'Accessibility',
            ['Accessibility', 'Saltation', 'Magnitude', 'Coriolis force'],
          ],
          [
            'Which demand is an urban challenge?',
            'Waste disposal',
            [
              'Waste disposal',
              'Arch collapse',
          ...
          [
            'What does segregation mean in an urban context?',
            'Separation of social or economic groups',
            [
              'Separation of social or economic groups',
              'Formation of spits',
              'Rotation of storms',
      ...
      makeTopic(
        'geo-economic-activity',
        'Economic Activity',
        'Iron Forge',
        'Not forged',
        [
          'Employment sectors are primary, secondary, tertiary and quaternary.',
          'Employment structures change as countries develop.',
          'The Clark Fisher Model shows how employment shifts between sectors over time.',
          'Economic activity location is affected by raw materials, globalisation, mechanisation, demography and government policy.',
          'Economic sector shifts can have positive and negative impacts in a named developed country.',
        ],
        [
          [
            'Which sector involves extracting raw materials?',
            'Primary',
            ['Primary', 'Secondary', 'Tertiary', 'Quaternary'],
          ],
          [
            'Which model explains changes in employment structure?',
            'Clark Fisher Model',
            [
              'Clark Fisher Model',
              'Richter Model',
          ...
          [
            'Which factor can affect the location of economic activity?',
            'Raw materials',
            [
              'Raw materials',
              'Swash only',
              'Wave-cut notches only',
              'Epicentre only',
            ],
          ],
        ]
      ...
      makeTopic(
        'geo-rural-urban-fringe',
        'Rural-Urban Fringe',
        'Gold Forge',
        'Not forged',
        [
          'The rural-urban fringe is the edge zone between the built-up city and the countryside.',
          'It can contain housing estates, retail parks, business parks, science parks and industrial estates.',
          'Greenfield sites are undeveloped land, often countryside.',
          'Brownfield sites are previously developed land that can be reused.',
          'The Greenfield versus Brownfield debate is about balancing development needs with environmental protection.',
        ],
        [
          [
            'What is the rural-urban fringe?',
            'Edge zone between city and countryside',
            [
              'Edge zone between city and countryside',
              'A coral reef',
              'A volcanic hotspot',
          ...
          [
            'Which one may be found at the rural-urban fringe?',
            'Retail park',
            ['Retail park', 'Stack', 'Epicentre', 'Mangrove root'],
          ],
        ]
      ),
      makeTopic(
        ...
        'Not forged',
        [
          'You need to know the aim of your urban environment enquiry.',
          'Sampling types include convenience, random and systematic sampling.',
          'A transect is a line of investigation, while a site is a specific location.',
          'Primary data is collected first-hand; secondary data already exists.',
          'Fieldwork evaluation should refer to accuracy, reliability and how the enquiry could be improved.',
        ],
        [
          [
            'Which type of data is collected first-hand?',
            'Primary data',
            [
              'Primary data',
              'Secondary data',
          ...
          [
            'What should fieldwork evaluation mention?',
            'Accuracy and reliability',
            [
              'Accuracy and reliability',
              'Only neat handwriting',
              'Only the title',
              'Only the weather',
            ],
          ],
  ...
  },
  {
    ...
    icon: Dumbbell,
    description:
      'GCSE PE — body systems, training, injury prevention and sports psychology.',
    topics: [
      makeTopic(
        'pe-skeletal-structure',
        ...
        [
          ...
          [
            'Which one is a function of the skeleton?',
            'Support',
            ['Support', 'Digestion', 'Breathing', 'Cooling the body'],
          ],
          [
            'Where are blood cells produced?',
            'Bone marrow',
            ['Bone marrow', 'Cartilage', 'Tendons', 'Ligaments'],
          ],
        ]
      ),
      makeTopic(
        'pe-synovial-structure',
        ...
        [
          ...
          [
            'What mainly absorbs shock in a synovial joint?',
            'Cartilage',
            ['Cartilage', 'Synovial fluid', 'Bone marrow', 'Ligament'],
          ],
        ]
      ),
      makeTopic(
        'pe-types-synovial-joint',
        ...
        [
          ...
          [
            'Which joint type mainly allows rotation?',
            'Pivot',
            ['Pivot', 'Hinge', 'Saddle', 'Fixed'],
          ],
        ]
      ),
      makeTopic(
        'pe-ranges-of-movement',
        'Ranges of Movement Allowed by Joints',
        'Steel Forge',
        'Not forged',
        [
      ...
      makeTopic(
        ...
        [
          ...
          [
            'Which muscle is found at the back of the upper arm?',
            'Triceps',
            ['Triceps', 'Biceps', 'Deltoid', 'Pectorals'],
          ],
          [
            'Which muscle is commonly called the calf muscle?',
            'Gastrocnemius',
            ['Gastrocnemius', 'Hamstrings', 'Latissimus dorsi', 'Abdominals'],
          ],
        ]
      ),
      makeTopic(
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Capillaries',
            ['Capillaries', 'Ligaments', 'Tendons', 'Cartilage'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            ...
            'Alveoli',
            ['Alveoli', 'Trachea', 'Ribs', 'Heart'],
          ],
          [
            'Which gas is removed when breathing out?',
            'Carbon dioxide',
      ...
      makeTopic(
        ...
        [
          [
            'Which type of exercise uses oxygen?',
            'Aerobic',
            ['Aerobic', 'Anaerobic', 'Static', 'Passive'],
          ],
          [
            'Which type is usually high intensity and short duration?',
            'Anaerobic',
            ['Anaerobic', 'Aerobic', 'Cool down', 'Flexibility'],
          ],
          [
            'What can build up during anaerobic exercise?',
            'Lactic acid',
            ['Lactic acid', 'Synovial fluid', 'Cartilage', 'Calcium only'],
          ],
        ]
      ),
      makeTopic(
        'pe-short-term-effects',
        ...
        [
          ...
          [
            ...
            [
              'To get more oxygen in',
              'To make bones stronger instantly',
      ...
      makeTopic(
        ...
        [
          [
            'What can happen to resting heart rate after endurance training?',
            'It can decrease',
            [
              'It can decrease',
              'It must increase',
          ...
          [
            'Which training type can increase muscle size and strength?',
            'Resistance training',
            [
              'Resistance training',
              'Only stretching',
          ...
          [
            'Weight-bearing exercise can help strengthen what?',
            'Bones',
            ['Bones', 'Synovial fluid', 'Airways only', 'Skin only'],
          ],
        ]
      ),
      makeTopic(
        'pe-components-fitness',
        ...
        [
          [
            'What does the bleep test measure?',
            'Cardiovascular endurance',
            ['Cardiovascular endurance', 'Flexibility', 'Power', 'Agility'],
          ],
          [
            'What does the vertical jump test measure?',
            'Power',
            ['Power', 'Speed', 'Balance', 'Reaction time'],
          ],
          [
            'What does the sit and reach test measure?',
            'Flexibility',
            ['Flexibility', 'Strength', 'Speed', 'Coordination'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Fitness can be lost if training stops',
            [
              'Fitness can be lost if training stops',
              'Fitness always stays forever',
              'Training only affects bones',
          ...
          [
            ...
            [
              'Frequency, Intensity, Time, Type',
              'Force, Impact, Tension, Tempo',
              'Flexion, Injury, Tendon, Training',
              'Fast, Intense, Tough, Timed',
            ],
          ],
        ]
      ),
      makeTopic(
        'pe-optimising-training',
        'Optimising Training',
        'Gold Forge',
        'Not forged',
        [
        ...
        [
          [
            ...
            'It allows recovery and adaptation',
            [
              'It allows recovery and adaptation',
          ...
          [
            'Why should training include progression?',
            'To keep improving',
            [
              'To keep improving',
              'To make it easier forever',
              'To avoid all movement',
              'To stop overload',
            ],
          ],
          [
            'What should training be matched to?',
            'The performer and sport',
            [
              'The performer and sport',
              'A random plan',
              'Only the weather',
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Returning the body to resting state',
            [
              'Returning the body to resting state',
              'Making the heart stop',
              'Instantly building muscle',
              'Preventing breathing',
            ],
          ],
          [
            'Which one can be part of a cool down?',
            'Low-intensity movement',
            [
              'Low-intensity movement',
              'Maximum sprinting only',
              'Heavy lifting only',
              'No movement at all',
            ],
          ],
      ...
      makeTopic(
        ...
        [
          [
            'Which one helps prevent injury?',
            'Correct technique',
            [
              'Correct technique',
              'Ignoring rules',
              'Skipping warm ups always',
              'Using broken equipment',
            ],
          ],
          [
            'Why is rest important for injury prevention?',
            'It reduces overuse risk',
            [
              'It reduces overuse risk',
              'It causes injuries',
              'It removes fitness instantly',
              'It stops recovery',
            ],
          ],
          [
            'Why should equipment be suitable?',
            'To keep performers safe',
            [
              'To keep performers safe',
              'To make sport harder',
              'To reduce movement',
              'To avoid rules',
            ],
          ],
      ...
      makeTopic(
        ...
        [
          [
            ...
            'Hazards',
            ['Hazards', 'Only winners', 'Only muscles', 'Only heart rate'],
          ],
          [
            'Which one could be a hazard?',
            'Faulty equipment',
            [
              'Faulty equipment',
              'Correct technique',
          ...
          [
            'What do control measures do?',
            'Reduce risk',
            [
              'Reduce risk',
              'Increase danger',
              'Remove rules',
              'Stop all sport forever',
            ],
          ],
        ]
      ),
      makeTopic(
        'pe-facep',
        'Characteristics of Skilful Movement: FACEP',
        'Master Forge',
        'Not forged',
        [
        ...
        [
          [
            'What does the F in FACEP stand for?',
            'Fluent',
            ['Fluent', 'Fast', 'Force', 'Fitness'],
          ],
          [
      ...
      makeTopic(
        ...
        [
          [
            ...
            'A skill affected by the environment',
            [
              'A skill affected by the environment',
              'A skill in a stable environment',
              'A skill with no decisions',
              'A skill that cannot improve',
            ],
          ],
          [
            ...
            [
              'A skill in a stable environment',
              'A skill affected by opponents',
              'A skill with no technique',
              'A skill that is always random',
            ],
          ],
          [
            'Which one is more complex?',
            'A skill with lots of decision making',
            [
              'A skill with lots of decision making',
              'A simple repeated action',
              'A movement with no pressure',
              'A movement with no information processing',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            ...
            [
              'Specific, Measurable, Achievable, Realistic, Time-bound',
              'Speed, Movement, Agility, Reaction, Timing',
              'Strength, Muscle, Aerobic, Rest, Training',
              'Simple, Massive, Active, Ready, Tough',
            ],
          ],
          [
          ...
          [
            ...
            [
              'The goal has a deadline',
              'The goal has no time limit',
              'The goal cannot be measured',
              'The goal is vague',
            ],
          ],
        ]
  ...
  },
  {
    ...
    icon: Microscope,
    description:
      'Biology — What is life, respiration, nutrition, transport, disease and immunity.',
    topics: [
      makeTopic(
        'bio-aerobic-respiration',
        'Aerobic Respiration',
        'Foundation Forge',
        'Not forged',
        [
        ...
        [
          ...
          [
            'Where does aerobic respiration mainly happen?',
            'Mitochondria',
      ...
      makeTopic(
        ...
        [
          ...
          [
            'Which nutrient is mainly used for energy?',
            'Carbohydrates',
            ['Carbohydrates', 'Fibre', 'Water', 'Minerals'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'Which molecule is mainly used as an energy source?',
            'Carbohydrate',
            ['Carbohydrate', 'Protein', 'Water', 'DNA only'],
          ],
          [
          ...
          [
            ...
            [
              ...
              'Making oxygen',
              'Destroying enzymes',
              'Carrying nerve impulses only',
            ],
          ],
        ]
      ),
      makeTopic(
        'bio-ingestion-mechanical-digestion',
        ...
        [
          ...
          [
            'Why is mechanical digestion useful?',
            'It increases surface area for enzymes',
            [
              'It increases surface area for enzymes',
              'It makes oxygen',
              'It stops digestion',
      ...
      makeTopic(
        ...
        [
          [
            ...
            'Small intestine',
            ['Small intestine', 'Stomach', 'Mouth', 'Large intestine'],
          ],
          [
            'What do villi do?',
          ...
          [
            ...
            'To carry absorbed molecules away',
            [
              'To carry absorbed molecules away',
              'To make food bigger',
              'To stop diffusion',
      ...
      makeTopic(
        ...
        [
          ...
          [
            'Where does gas exchange happen?',
            'Alveoli',
            ['Alveoli', 'Stomach', 'Kidney', 'Small intestine'],
          ],
          [
            ...
            [
              ...
              'From stomach into lungs',
              'From kidney into mouth',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            ...
            'Oxygen',
            ['Oxygen', 'Bile', 'Enzymes only', 'Bones'],
          ],
          [
          ...
          [
            ...
            'Blood clotting',
            ['Blood clotting', 'Oxygen transport', 'Digestion', 'Breathing'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'What does the heart do?',
            'Pumps blood',
            ['Pumps blood', 'Makes oxygen', 'Stores urine', 'Digests food'],
          ],
          [
            'What do arteries do?',
            'Carry blood away from the heart',
          ...
          [
            ...
            'Capillaries',
            ['Capillaries', 'Veins only', 'Arteries only', 'Platelets'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Lungs',
            ['Lungs', 'Kidneys', 'Liver', 'Stomach'],
          ],
          [
            'Which organs remove urea from the blood?',
            'Kidneys',
            ['Kidneys', 'Lungs', 'Heart', 'Small intestine'],
          ],
        ]
      ),
      makeTopic(
        'bio-life-without-transport-systems',
        'Life Without Transport Systems',
        'Silver Forge',
        'Not forged',
        [
        ...
        [
          [
            'Why can small organisms rely on diffusion?',
            'Large surface area to volume ratio',
            [
              'Large surface area to volume ratio',
              'They have no cells',
              'They have no need for oxygen',
              'They cannot respire',
            ],
          ],
          [
            ...
            [
              'Movement from high to low concentration',
              'Movement from low to high concentration only',
              'Pumping blood',
              'Breaking down food',
            ],
          ],
      ...
      makeTopic(
        ...
        [
          ...
          [
            'What can build up after anaerobic respiration?',
            'Lactic acid',
            ['Lactic acid', 'Oxygen', 'Bile', 'Fibre'],
          ],
        ]
      ),
      makeTopic(
        'bio-thermoregulation',
        'Thermoregulation',
        'Gold Forge',
        'Not forged',
        [
        ...
        [
          ...
          [
            ...
            [
              'Enzymes need the right temperature',
              'Bones need to melt',
              'Blood must stop moving',
              'Cells do not need enzymes',
            ],
          ],
        ]
      ),
      makeTopic(
        'bio-lifestyle-diseases',
        'Lifestyle Diseases',
        'Gold Forge',
        'Not forged',
        [
        ...
        [
          [
            ...
            [
              'Something that increases the chance of disease',
              'Something that guarantees health',
              'A type of blood cell',
              'A digestive enzyme',
            ],
          ],
          [
            'Smoking increases the risk of which disease type?',
            'Lung disease',
            [
              'Lung disease',
              'Only broken bones',
              'Only tooth growth',
              'Only cartilage damage',
            ],
          ],
          [
            ...
            [
              'A relationship between factors',
              'Definite proof of causation every time',
              'No link at all',
              'A type of enzyme',
            ],
          ],
      ...
      makeTopic(
        ...
        [
          [
            ...
            'Pathogens',
            ['Pathogens', 'Only exercise', 'Only bones', 'Only oxygen'],
          ],
          [
            'Which one is a pathogen?',
            'Virus',
            ['Virus', 'Red blood cell', 'Platelet', 'Alveolus'],
          ],
          [
            'Which one can reduce disease spread?',
            'Good hygiene',
            [
              'Good hygiene',
      ...
      makeTopic(
        ...
        [
          [
            'Which cells are important in immunity?',
            'White blood cells',
            [
              'White blood cells',
          ...
          [
            ...
            'Antigens',
            ['Antigens', 'Cartilage', 'Synovial fluid', 'Glucose only'],
          ],
          [
  ...
  },
  {
    ...
    icon: Cpu,
    description:
      'Design Technology — CAM, electronics, structures and mechanisms.',
    topics: [
      makeTopic(
        'dt-cam',
        ...
        [
          [
            ...
            [
              ...
              'Controlled Automatic Motion',
              'Computer Aided Marketing',
            ],
          ],
          [
            'Which one is a benefit of CAM?',
            'Accurate repeat production',
            [
              'Accurate repeat production',
              'Always cheaper to set up',
              'No need for electricity',
              'Only works by hand',
            ],
          ],
          [
            'What type of machines are used in CAM?',
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            [
              'They improve electrical safety',
              'They always conduct better',
              'They make circuits faster only',
      ...
      makeTopic(
        ...
        [
          [
            'What are the main parts of a systems diagram?',
          ...
          [
            ...
            'Sends information back into the system',
            [
              'Sends information back into the system',
              'Removes the input',
              'Stops the circuit',
              'Changes volts into amps',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'Why are circuit symbols used?',
            'To represent components clearly',
            [
              'To represent components clearly',
              'To decorate the product',
              'To calculate density',
              'To show only materials',
            ],
          ],
          [
          ...
          [
            'Which one is an electronic component?',
            'Resistor',
            ['Resistor', 'Fulcrum', 'Beam', 'Rack'],
          ],
        ]
      ),
      makeTopic(
      ...
      makeTopic(
        ...
        [
          [
            'What is a frame structure made from?',
            'Joined members',
            [
              'Joined members',
              'Only liquid',
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Backwards and forwards in an arc',
            [
              'Backwards and forwards in an arc',
              'Straight line movement',
              'A circuit output',
        ...
        [
          [
            ...
            [
              ...
              'Stores current',
              'Increases voltage',
              'Creates a shell structure',
            ],
          ],
          [
            'Which component reduces friction?',
            'Bearings',
            ['Bearings', 'Insulators', 'Fulcrums', 'Resistors'],
          ],
          [
            ...
            [
              'Reducing friction',
              'Increasing shear',
              'Making circuits open',
              'Changing amps into volts',
            ],
          ],
        ]
      ),
      ...
      makeTopic(
        ...
        [
          [
            'What happens when a small driver turns a larger driven gear?',
            'Speed reduces and torque increases',
            [
              'Speed reduces and torque increases',
              'Speed increases and torque reduces',
              'Both stop',
              'Only friction changes',
            ],
          ],
          [
            'What happens when a large driver turns a smaller driven gear?',
            'Speed increases and torque reduces',
            [
              'Speed increases and torque reduces',
              'Speed reduces and torque increases',
              'No motion is transmitted',
              'It becomes linear motion only',
            ],
          ],
          [
            'What can an idler gear be used for?',
            'Changing direction',
            [
              'Changing direction',
              'Insulating wires',
      ...
      makeTopic(
        ...
        [
          [
            'What does rack and pinion convert?',
          ...
          [
            'What does a crank and piston involve?',
            'Rotary and reciprocating motion',
            [
              'Rotary and reciprocating motion',
              'Only insulation',
              'Only shell structures',
              'Only unit prefixes',
            ],
          ],
          [
            'Which mechanism uses sprockets?',
            'Chain and sprockets',
            [
              'Chain and sprockets',
              'Belt and pulley',
  ...
  },
  {
    ...
    icon: Microscope,
    description:
      'Chemistry — bonding, crude oil, energetics and chemical tests.',
    topics: [
      makeTopic(
        ...
        [
          [
            ...
            '2,8,8,2',
            ['2,8,8,2', '2,8,5', '2,7', '2,8,6'],
          ],
          [
            'How do metals usually form ions?',
            'They lose electrons',
            [
              'They lose electrons',
              'They gain electrons',
          ...
          [
            'What charge does a metal ion usually have?',
            'Positive',
            ['Positive', 'Negative', 'Neutral', 'No charge possible'],
          ],
          [
            'How do non-metals usually form ions?',
            'They gain electrons',
            [
              'They gain electrons',
              'They lose electrons',
          ...
          [
            ...
            [
              ...
              'To become larger only',
              'To change into a compound automatically',
            ],
          ],
        ]
      ),
        ...
        [
          [
            ...
            [
              ...
              'Metals lose electrons to a sea',
          ...
          [
            ...
            'They show outer electrons and shared pairs',
            [
              'They show outer electrons and shared pairs',
              'They show boiling points only',
              'They show speed',
              'They show pressure',
            ],
          ],
          [
            'In a covalent bond, the shared electrons count towards which atoms?',
            'Both bonded atoms',
            [
              'Both bonded atoms',
              'Only the larger atom',
              'Only the smaller atom',
              'Neither atom',
            ],
          ],
        ]
      ...
      makeTopic(
        ...
        [
          [
            ...
            [
              'Electrons are transferred',
              'Electrons are shared only',
              'Protons are shared',
              'Neutrons are removed',
            ],
          ],
          [
            'Which type of atom usually loses electrons in ionic bonding?',
            'Metal',
            ['Metal', 'Non-metal', 'Noble gas', 'Halogen only'],
          ],
          [
            'What charge does lithium form in lithium fluoride?',
            '+1',
            ['+1', '-1', '+2', '0'],
          ],
          [
          ...
          [
            'Why do ionic compounds hold together?',
            'Oppositely charged ions attract',
            [
              'Oppositely charged ions attract',
              'They have no charge',
              'They repel each other',
              'They contain only gases',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            ...
            'Hydrocarbons',
            ['Hydrocarbons', 'Salts', 'Metals', 'Noble gases'],
          ],
          [
          ...
          [
            ...
            [
              ...
              'It turns limewater cloudy only',
              'It makes fuels burn faster',
            ],
          ],
          [
            'Why is cracking needed?',
            'To make shorter useful hydrocarbons from long-chain hydrocarbons',
            [
              'To make shorter useful hydrocarbons from long-chain hydrocarbons',
              'To remove all carbon',
              'To make crude oil from water',
              'To stop combustion',
            ],
          ],
        ]
      ...
      makeTopic(
        'chem-energetics',
        'Heat, Temperature and Energetics',
        'Bronze Forge',
        'Not forged',
        [
        ...
        [
          ...
          [
            'What type of reaction gives out heat energy?',
            'Exothermic',
            ['Exothermic', 'Endothermic', 'Neutral only', 'Ionic only'],
          ],
          [
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Ammonia',
            ['Ammonia', 'Oxygen', 'Hydrogen', 'Carbon dioxide'],
          ],
          [
      ...
      makeTopic(
        ...
        [
          [
            ...
            'Crimson red',
            ['Crimson red', 'Yellow', 'Lilac', 'Blue-green'],
          ],
          [
            'What colour is sodium in a flame test?',
            'Yellow',
            ['Yellow', 'Crimson red', 'Brick red', 'Green'],
          ],
          [
            'What colour is potassium in a flame test?',
            'Lilac',
            ['Lilac', 'Yellow', 'Blue-green', 'Brown'],
          ],
          [
            'What colour is calcium in a flame test?',
            'Brick red',
            ['Brick red', 'Lilac', 'Yellow', 'White'],
          ],
          [
            'What colour is copper in a flame test?',
            'Blue-green',
            ['Blue-green', 'Crimson red', 'Lilac', 'Yellow'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          ...
          [
            'What colour precipitate does Cu²⁺ form with sodium hydroxide?',
            'Blue',
            ['Blue', 'Green', 'Brown', 'White'],
          ],
          [
            'What colour precipitate does Fe²⁺ form with sodium hydroxide?',
            'Green',
      ...
      makeTopic(
        ...
        [
          [
            ...
            'White',
            ['White', 'Cream', 'Yellow', 'Blue'],
          ],
          [
            'What colour precipitate do bromide ions form with silver nitrate?',
            'Cream',
            ['Cream', 'White', 'Yellow', 'Brown'],
          ],
          [
            'What colour precipitate do iodide ions form with silver nitrate?',
            'Yellow',
            ['Yellow', 'White', 'Cream', 'Green'],
          ],
          [
            'What precipitate shows sulfate ions are present?',
            'Dense white barium sulfate',
            [
              'Dense white barium sulfate',
              'Blue copper hydroxide',
              'Brown iron hydroxide',
              'Yellow sodium chloride',
            ],
          ],
          [
            'What gas is produced when carbonate ions react with dilute hydrochloric acid?',
            'Carbon dioxide',
            ['Carbon dioxide', 'Hydrogen', 'Oxygen', 'Chlorine'],
          ],
        ]
      ),
    ],
  },
  {
    ...
    icon: Microscope,
    description:
      'Physics — motion, forces, energy, electricity, radioactivity, space, states of matter and magnetism.',
    topics: [
      makeTopic(
        'phys-motion-position',
        ...
        [
          ...
          [
            ...
            'Acceleration',
            ['Acceleration', 'Density', 'Pressure', 'Weight'],
          ],
          [
          ...
          [
            'Which equation links final velocity, initial velocity, acceleration and displacement?',
            'v² = u² + 2as',
            ['v² = u² + 2as', 'F = ma', 'W = mg', 'V = IR'],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            ...
            [
              ...
              'A vector has no size',
              'They are the same',
            ],
          ],
          [
            'What is stopping distance made from?',
          ...
          [
            ...
            'Friction',
            ['Friction', 'Weight', 'Current', 'Radiation'],
          ],
          [
      ...
      makeTopic(
        ...
        [
          [
            ...
            'F = ma',
            ['F = ma', 'V = IR', 'E = QV', 'p = F/A'],
          ],
          [
            'What is the equation for weight?',
            'W = mg',
            ['W = mg', 'F = ma', 'v² = u² + 2as', 'E = QV'],
          ],
          [
            'What is the equation for pressure?',
            'p = F/A',
            ['p = F/A', 'V = IR', 'Q = It', 'ρ = m/V'],
          ],
          [
            'What is the equation for density?',
            'ρ = m/V',
            ['ρ = m/V', 'W = mg', 'F = ma', 'V = IR'],
          ],
          [
            'What does gravitational field strength help calculate?',
            'Weight',
            ['Weight', 'Current', 'Voltage', 'Half-life'],
          ],
        ]
      ),
      makeTopic(
        'phys-energy-transfers',
        ...
        [
          [
            'Which statement describes conservation of energy?',
            'Energy cannot be created or destroyed',
            [
              'Energy cannot be created or destroyed',
              'Energy disappears in machines',
          ...
          [
            'Name one method of thermal energy transfer.',
            'Conduction',
            ['Conduction', 'Ionisation', 'Fission only', 'Condensation only'],
          ],
          [
            'Which energy store is found in food and fuels?',
            'Chemical',
            ['Chemical', 'Magnetic only', 'Nuclear only', 'Electrostatic only'],
          ],
          [
            'What type of transfer happens in electrical circuits?',
            'Electrical transfer',
            [
              'Electrical transfer',
              'No transfer',
              'Only mechanical transfer',
              'Only sound transfer',
            ],
          ],
        ]
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Coulomb',
            ['Coulomb', 'Volt', 'Newton', 'Pascal'],
          ],
          [
            'What is the current through components in series like?',
            'The same through each component',
            [
              'The same through each component',
              'Zero in every component',
              'Always different',
              'Only in the battery',
            ],
          ],
      ...
      makeTopic(
        ...
        [
          ...
          [
            ...
            'Becquerels',
            ['Becquerels', 'Newtons', 'Volts', 'Pascals'],
          ],
          [
            'What is half-life?',
            ...
            [
              'Time for activity to halve',
              'Time for mass to double',
              'Time for voltage to halve',
              'Time for speed to reach zero',
            ],
          ],
          [
            'Which detector can detect ionising radiation?',
            'Geiger-Müller detector',
            ['Geiger-Müller detector', 'Thermometer', 'Ammeter only', 'Ruler'],
          ],
        ]
      ),
      makeTopic(
        'phys-astronomy-cosmology',
        ...
        [
          [
            ...
            'Gravity',
            ['Gravity', 'Friction', 'Static electricity', 'Nuclear radiation'],
          ],
          [
            ...
            [
              'The universe is expanding',
              'The universe is shrinking only',
          ...
          [
            'Which diagram shows star classification?',
            'HR diagram',
            [
              'HR diagram',
              'Circuit diagram',
      ...
      makeTopic(
        'phys-states-of-matter',
        'States of Matter and Gas Molecules',
        'Silver Forge',
        'Not forged',
        [
        ...
        [
          ...
          [
            ...
            [
              ...
              'Particles disappear',
              'Particles become radioactive',
            ],
          ],
          [
            'What happens to gas molecule speed when temperature increases?',
      ...
      makeTopic(
        'phys-magnetism-electromagnetism',
        ...
        [
          ...
          [
            'What does an electric current produce around a wire?',
            'A magnetic field',
            [
              'A magnetic field',
              'A nuclear reaction',
          ...
          [
            'What is often used inside an electromagnet to make it stronger?',
            'Iron core',
            ['Iron core', 'Plastic core', 'Glass core', 'Wood core'],
          ],
          [
            'What device uses the force on a current-carrying wire in a magnetic field?',
            'Electric motor',
            [
              'Electric motor',
              'Geiger counter only',
          ...
          [
            'What rule predicts the direction of force on a wire?',
            'Left-hand rule',
            [
              'Left-hand rule',
              'Right-hand grip rule only',
              "Ohm's law",
              "Hooke's law",
            ],
          ],
  ...
  },
  {
    ...
    icon: BookOpen,
    description:
      'History — German Unification, Bismarck and the 1848 revolutions across Europe.',
    topics: [
      makeTopic(
        'hist-german-unification-1848-50',
        'Why Germany Was Not Unified, 1848–50',
        'Foundation Forge',
        'Not forged',
        [
        ...
        [
          [
            'How many states made up the German Confederation after 1815?',
            '39',
            ['39', '25', '12', '52'],
          ],
          [
            'Which power dominated the German Confederation after 1815?',
            'Austria',
            ['Austria', 'France', 'Britain', 'Italy'],
          ],
          [
            'Why did the Frankfurt Parliament fail?',
            'It lacked army, money and support from rulers',
            [
              'It lacked army, money and support from rulers',
              'It was supported by Austria',
              'It had too much military power',
              'It wanted to keep Germany divided',
            ],
          ],
          [
            'What crown did Frederick William IV refuse in 1849?',
            'The imperial crown of a united Germany',
            [
              'The imperial crown of a united Germany',
              'The Austrian crown',
              'The French crown',
          ...
          [
            'What did the Punctuation of Olmütz do?',
            'Forced Prussia to back down and restored Austrian influence',
            [
              'Forced Prussia to back down and restored Austrian influence',
              'Created the German Empire',
              'Removed Austria from Germany',
      ...
      makeTopic(
        'hist-zollverein-nationalism',
        'German Nationalism and the Zollverein',
        'Foundation Forge',
        'Not forged',
        [
        ...
        [
          [
            ...
            'A Prussian-led customs union',
            [
              'A Prussian-led customs union',
              'An Austrian army',
              'A French parliament',
              'A failed Italian republic',
            ],
          ],
          [
          ...
          [
            'Which major German power was excluded from the Zollverein?',
            'Austria',
            ['Austria', 'Prussia', 'Bavaria', 'Saxony'],
          ],
          [
            'What did the Zollverein remove between member states?',
            'Internal tariffs',
            [
              'Internal tariffs',
              'All monarchies',
          ...
          [
            'Which festival in 1832 showed growing nationalism?',
            'Hambach Festival',
            [
              'Hambach Festival',
              'Congress of Vienna',
      ...
      makeTopic(
        'hist-bismarck-austria-1866',
        'How Bismarck Defeated Austria in 1866',
        'Steel Forge',
        'Not forged',
        [
        ...
        [
          [
            'When was Bismarck appointed Minister-President of Prussia?',
            '1862',
            ['1862', '1848', '1866', '1871'],
          ],
          [
            'What type of politics did Bismarck use?',
            'Realpolitik',
            ['Realpolitik', 'Communism', 'Isolationism', 'Absolutism only'],
          ],
          [
            'What did the Convention of Gastein do?',
            'Split control of Schleswig and Holstein',
            [
              'Split control of Schleswig and Holstein',
              'United Germany',
              'Gave Alsace-Lorraine to Germany',
              'Created the Frankfurt Parliament',
            ],
          ],
          [
            'Which country allied with Prussia against Austria?',
            'Italy',
            ['Italy', 'France', 'Britain', 'Russia'],
          ],
          [
            'Which battle showed Prussian superiority in 1866?',
            'Königgrätz',
            ['Königgrätz', 'Sedan', 'Waterloo', 'Novara'],
          ],
        ]
      ),
      makeTopic(
        'hist-bismarck-france-1870',
        'How Bismarck Defeated France in 1870',
        'Steel Forge',
        'Not forged',
        [
        ...
        [
          [
            'What crisis did Bismarck use to provoke France?',
            'The Spanish Succession Crisis',
            [
              'The Spanish Succession Crisis',
              'The Crimean War',
              'The Punctuation of Olmütz',
              'The March Laws',
            ],
          ],
          [
            'What did Bismarck edit to provoke France?',
            'The Ems Telegram',
            [
              'The Ems Telegram',
          ...
          [
            'Which battle led to Napoleon III being captured?',
            'Sedan',
            ['Sedan', 'Königgrätz', 'Novara', 'Sadowa'],
          ],
          [
            'What land did France lose after the Franco-Prussian War?',
            'Alsace-Lorraine',
            ['Alsace-Lorraine', 'Schleswig', 'Holstein', 'Bavaria'],
          ],
          [
            'Why was the Franco-Prussian War important for unification?',
            'It united the southern German states behind Prussia',
            [
              'It united the southern German states behind Prussia',
              "It restored Austria's control",
              'It ended the Zollverein',
              'It made France part of Germany',
            ],
          ],
        ]
      ),
      makeTopic(
        'hist-bismarck-responsibility',
        ...
        [
          [
            "What were the three main views of Bismarck's role?",
            'Master planner, opportunist, or less important than other factors',
            [
              'Master planner, opportunist, or less important than other factors',
              'King, emperor and soldier',
              'Liberal, socialist and communist',
              'French, Austrian and Italian',
            ],
          ],
          [
            'What speech showed Bismarck believed force would matter?',
            'Blood and Iron',
            [
              'Blood and Iron',
              'Peace and Freedom',
          ...
          [
            'Who reorganised and strengthened the Prussian army?',
            'Von Roon',
            ['Von Roon', 'Metternich', 'Louis Philippe', 'Mazzini'],
          ],
          [
            'Who improved Prussian military strategy?',
            'Von Moltke',
            ['Von Moltke', 'Guizot', 'Charles Albert', 'Kossuth'],
          ],
          [
            'Which economic factor helped German unification?',
            'The Zollverein',
            [
              'The Zollverein',
              'The June Days',
      ...
      makeTopic(
        ...
        [
          [
            'What caused prices to surge in 1846?',
            'A terrible corn harvest',
            [
              'A terrible corn harvest',
              'A successful war',
              'The Zollverein',
          ...
          [
            'Why was the French political system seen as corrupt?',
            'Only a small percentage could vote',
            [
              'Only a small percentage could vote',
              'Everyone could vote',
              'There was no king',
              'France had no newspapers',
            ],
          ],
          [
            'What was the purpose of the banquets?',
            'To discuss political views and reforms',
            [
              'To discuss political views and reforms',
              'To crown Bismarck',
              'To start the Zollverein',
              'To elect the Pope',
            ],
          ],
          [
          ...
          [
            'Why were the June Days important?',
            'They marked the end of hopes for a democratic and social republic',
            [
              'They marked the end of hopes for a democratic and social republic',
              'They created the German Empire',
              'They defeated Austria',
              'They created the Zollverein',
            ],
          ],
        ]
      ),
      makeTopic(
        ...
        [
          [
            'Which Italian states were under Austrian control?',
          ...
          [
            'Who ruled Piedmont-Sardinia?',
            'Charles-Albert',
            ['Charles-Albert', 'Metternich', 'Bismarck', 'Louis Philippe'],
          ],
          [
            'What happened in January 1848 in Italy?',
          ...
          [
            'Which Italian state was defeated at Novara?',
            'Piedmont',
            ['Piedmont', 'Venice', 'Prussia', 'France'],
          ],
          [
            'Why did the Italian revolutions fail?',
            'Lack of unity and Austrian strength',
            [
              'Lack of unity and Austrian strength',
              'Too much support from Austria',
              'Germany was already united',
              'France had no role',
            ],
          ],
        ]
      ...
      makeTopic(
        ...
        [
          [
            'What sparked revolution in Germany in 1848?',
          ...
          [
            'When did the Frankfurt Parliament meet?',
            'May 1848',
            ['May 1848', 'January 1848', 'August 1849', 'December 1871'],
          ],
          [
            "What were the Frankfurt Parliament's main goals?",
            'Unite Germany and create a liberal constitution',
            [
              'Unite Germany and create a liberal constitution',
              'Restore Austria completely',
              'Abolish all German states',
              'Make France stronger',
            ],
          ],
          [
            'Who dominated the Frankfurt Parliament?',
          ...
          [
            'What did many peasants gain during the revolution?',
      ...
      makeTopic(
        ...
        [
          ...
          [
            'Why was the Austrian Empire unstable?',
            'It had many nationalities, languages and cultures',
            [
              'It had many nationalities, languages and cultures',
              'It had no army',
              'It had no monarchy',
              'It was already united with Germany',
            ],
          ],
          [
            "Who controlled Austria's conservative system before 1848?",
            'Metternich',
            ['Metternich', 'Bismarck', 'Mazzini', 'Napoleon III'],
          ],
          [
            'Where did Metternich flee?',
            'England',
            ['England', 'Prussia', 'Italy', 'Russia'],
          ],
          [
            'How did Metternich try to keep control?',
  ...
  geography: [
    {
      ...
      points: [
        'The Geography EOY is worth 90 marks and lasts 1 hour 30 minutes.',
        'The paper has a separate resource booklet and you answer every question.',
        'The four sections are Coasts, Hazards, Urban and Economic Activity, and Human Fieldwork.',
        'Bring a ruler and calculator because the paper can use maps, graphs and data.',
      ],
    },
    {
      title: 'Coastal Environments',
      points: [
        'Know marine processes: wave action, erosion, transportation, deposition and longshore drift.',
        'Know sub-aerial processes: mechanical, chemical and biological weathering plus mass movement.',
        'Landforms include headlands and bays, cliffs, wave-cut platforms, caves, arches, stacks, stumps, beaches, spits and bars.',
        'Coastal ecosystems include coral reefs, mangroves, sand dunes and salt marshes.',
      ],
    },
    {
      ...
      points: [
        'Know the characteristics, distribution and measurement of earthquakes, volcanoes and tropical cyclones.',
        'Tectonic hazards are linked to plate boundaries and hotspots.',
        'Tropical cyclones need warm ocean water, low pressure, Coriolis force and low wind shear.',
        'Hazard answers should separate causes, impacts, vulnerability, preparation, response and management.',
      ],
    },
    {
      title: 'Urban and Economic Activity',
      points: [
        'Know urbanisation, suburbanisation, counter-urbanisation, megacities and problems of rapid urban growth.',
        'Urban land use is affected by locational needs, accessibility and land values.',
        'Economic sectors are primary, secondary, tertiary and quaternary, and employment structures change with development.',
        'Use the Clark Fisher Model and examples of raw materials, globalisation, mechanisation, demography and government policy.',
      ],
    },
    {
      title: 'Human Fieldwork',
      points: [
        'Know the aim, methods, sampling strategy, data presentation, conclusions and evaluation of your urban enquiry.',
        'Sampling types include convenience, random and systematic sampling.',
        'Know the difference between qualitative and quantitative data and primary and secondary methods.',
        'Evaluation should refer to accuracy, reliability and improvements.',
      ],
    },
  ],
  history: [
...
function isBroadAnswerCorrect(question, userAnswer) {
  ...
  const matchedTokens = correctTokens.filter((token) =>
  ...
  if (correctTokens.length === 1) {
    ...
    return userTokens.some(
      (token) => target.includes(token) || token.includes(target)
    );
  }
  ...
  return (
    matchedTokens.length >= Math.max(2, Math.ceil(correctTokens.length * 0.5))
  );
}
...
function OceanThemeBackground() {
  ...
  const fish = useMemo(() => {
    ...
    return fishBase.map((item, i) => {
      const colour =
        fishColours[Math.floor(Math.random() * fishColours.length)];
      return {
        ...item,
        ...colour,
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      ...
      {fish.map((item, i) => (
        <span
          key={`fish-${i}`}
          className={`ocean-fish absolute block ${
            item.rainbow ? 'ocean-fish-rainbow' : ''
          }`}
          style={{
            top: item.top,
...
function GoldThiefOverlay({ mousePosition }) {
  ...
  const mouseBlocking =
    ...
    taskbarVisible &&
    mousePosition &&
    mousePosition.y < taskbarBottom + 85 &&
    Math.abs(mousePosition.x - thiefX) < 90;
...
function JapanCarOverlay({ mousePosition, onJumpUnlock }) {
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      setRun((previous) => {
        ...
        const blockedSince = isMouseBlocking
          ? previous.blockedSince || now
          : null;
        ...
        const frozenStartTime =
          previous.startTime +
          ((previous.x + 260) / (screenWidth + 520)) * previous.duration;
        const elapsed = Math.max(
          0,
          now - (shouldPause ? frozenStartTime : previous.startTime)
        );
        const progress = Math.min(1, elapsed / previous.duration);
        const nextX = shouldPause
          ? previous.x
          : -260 + progress * (screenWidth + 520);
  ...
  return (
    <div className="pointer-events-none fixed left-0 top-[42px] z-[31] h-16 w-screen overflow-visible">
      <div
        className={`japan-supra-run ${burnout ? 'japan-supra-burnout' : ''} ${
          jumping ? 'japan-supra-jumping' : ''
        }`}
        style={{
...
function ThemeBackground({ activeThemeId, volcanoEruptionKey }) {
  ...
  if (activeThemeId === 'volcano')
    return <VolcanoThemeBackground key={volcanoEruptionKey} />;
        ...
        <div>
          <p
            className={`text-sm font-bold uppercase tracking-widest ${
              unlocked ? theme.accent : 'text-zinc-500'
            }`}
          >
...
function getOcrPastPaperSection(subject, selectedSection) {
  ...
  const subjectName =
    ocrSubjectSearchNames[subject.id] || `GCSE ${subject.title}`;
    ...
    <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-5 md:p-6">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-2xl font-black text-white">
          General {selectedSubject.title} Knowledge
        </h2>
      </div>
      <p className="mt-2 text-sm text-zinc-400">
        This is the broader knowledge you need before attacking the locked
        stages.
      </p>
    ...
    <div className="mt-5 space-y-5">
      {questions.map((item, index) => {
        ...
        const writtenCorrect =
          submitted && isWritten && isBroadAnswerCorrect(item, answers[index]);
...
const defaultUnlockedStages = {
  'lang-section-a-overview': true,
  'lit-my-last-duchess': true,
  'geo-exam-overview': true,
...
export default function App() {
  ...
  const [breakMinutes, setBreakMinutes] = useState(
    savedProgress?.breakMinutes || 5
  );
  const [revisionSeconds, setRevisionSeconds] = useState(
    savedProgress?.revisionSeconds || 0
  );
  const [breakAlarm, setBreakAlarm] = useState(false);
  const [lastBreakMarker, setLastBreakMarker] = useState(
    savedProgress?.lastBreakMarker || 0
  );
  ...
  const [selectedTopicId, setSelectedTopicId] = useState(
    savedProgress?.selectedTopicId || subjects[0].topics[0].id
  );
  ...
  const [allThemesUnlocked, setAllThemesUnlocked] = useState(
    savedProgress?.allThemesUnlocked || false
  );
  const [themeActions, setThemeActions] = useState(
    savedProgress?.themeActions || {}
  );
  ...
  const [activeThemeId, setActiveThemeId] = useState(
    savedProgress?.activeThemeId || 'forge'
  );
  ...
  const sectionSubject = useMemo(
    () => ({ ...selectedSubject, topics: sectionTopics }),
    [selectedSubject, sectionTopics]
  );
  ...
  const subjectSuperTestReady =
    sectionTopics.length > 0 &&
    sectionTopics.every((topic) => unlocked[topic.id]);
  ...
  const superTestScore = useMemo(() => {
    const correct = superTestQuestions.filter((question, index) =>
      isBroadAnswerCorrect(question, superTestAnswers[index])
    ).length;
    return superTestQuestions.length
      ? Math.round((correct / superTestQuestions.length) * 100)
      : 0;
  ...
  const score = useMemo(() => {
    const correct = selectedTopic.questions.filter(
  ...
  const dailyScore = useMemo(() => {
    const correct = dailyQuestions.filter((item, index) => {
      if (item.type === 'written')
        return isBroadAnswerCorrect(item, dailyAnswers[index]);
  ...
  const subjectTopicIndex = sectionTopics.findIndex(
  ...
  const subjectUnlockedCount = sectionTopics.filter(
    (topic) => unlocked[topic.id]
  ).length;
  const maxForgedInAnySubject = Math.max(
    ...visibleSubjects.map(
  ...
  const recallPercentage = useMemo(() => {
    ...
    const unlockScore = sectionTopics.length
      ? Math.round((unlockedInSubject / sectionTopics.length) * 100)
      : 0;
  ...
  const activeTheme =
    themes.find(
      (theme) => theme.id === activeThemeId && isThemeUnlocked(theme)
    ) || themes[0];
  ...
  function changeSubject(subject) {
    ...
    const firstUnlockedTopic =
      subject.topics.find((topic) => unlocked[topic.id]) || subject.topics[0];
  ...
  return (
    <div
      ...
      className={`relative min-h-screen overflow-hidden ${
        ...
        activeThemeId === 'cherry'
          ...
          : activeThemeId === 'cyber'
          ? 'cyber-theme'
          : activeThemeId === 'arctic'
          ? 'arctic-theme'
          : activeThemeId === 'volcano'
          ? 'volcano-theme'
          : activeThemeId === 'god'
          ? 'god-theme'
          : ''
    ...
    >
      <ThemeBackground
        ...
        volcanoEruptionKey={volcanoEruptionKey}
      />
      {activeThemeId === 'cherry' && <CherryPetalsOverlay />}
      {activeThemeId === 'gold' && (
        <GoldThiefOverlay mousePosition={mousePosition} />
      )}
      {activeThemeId === 'japan' && (
        <JapanCarOverlay
          mousePosition={mousePosition}
          onJumpUnlock={() => unlockThemeAction('japanCarJumped')}
        />
      )}
      {themeUnlockCodeOpen && view === 'settings' && (
        <div
          className="fixed inset-0 flex items-center justify-center bg-black px-4 backdrop-blur-md"
          style={{ zIndex: 99999 }}
        >
      ...
      {breakAlarm && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center overflow-hidden bg-black/78 px-4 backdrop-blur-sm">
          ...
          <div className="relative w-full max-w-lg rounded-3xl border border-orange-300/40 bg-zinc-950/92 p-8 text-center shadow-2xl shadow-orange-950/50">
            ...
            <p className="mt-2 text-xl font-black uppercase tracking-[0.32em] text-orange-200">
              Alarm triggered
            </p>
            <p className="mt-3 text-zinc-300">
              You have revised for {workMinutes} minutes. Take a {breakMinutes}{' '}
              minute break, then come back and keep forging.
            </p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="relative w-full max-w-md rounded-3xl border border-orange-400/40 bg-zinc-950 p-6 shadow-2xl shadow-orange-950/40">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-400">
              Enter a username so this device can remember your unlocked stages,
              selected theme and subject progress.
            </p>

            <label className="mt-5 block text-xs font-bold uppercase tracking-widest text-orange-300">
              Username
            </label>
            <input
              value={usernameInput}
      ...
      {showSubjectSetupPrompt && view === 'home' && (
        ...
        >
          <div className="relative max-h-[86vh] w-full max-w-3xl overflow-y-auto rounded-3xl border border-orange-400/40 bg-zinc-950 p-6 shadow-2xl shadow-orange-950/40">
            ...
            <h2 className="text-3xl font-black text-white">
              Choose your subject slots
            </h2>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
              Pick the subjects you want in your taskbar. This uses the same
              subject slots as Settings. Empty every slot to show every subject.
            </p>

            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {subjectSlots.map((slotSubjectId, index) => (
                <label
                  key={`startup-slot-${index}`}
      ...
      <div className="relative z-10">
        <div className="taskbar-solid sticky top-0 z-30 border-b border-zinc-800 bg-zinc-950 px-4 py-3 shadow-lg">
          <div className="relative mx-auto max-w-7xl">
            <div className="flex items-center justify-between gap-2 overflow-x-auto">
              ...
              >
                Subjects:{' '}
                <span className="text-white">{selectedSubject.title}</span>{' '}
                <ChevronDown
              ...
              >
                <LibraryBig className="h-4 w-4" /> General
              </button>
              <button
                onClick={goToStages}
                className={`inline-flex shrink-0 items-center gap-2 rounded-xl px-3 py-2 text-sm font-bold ${
              ...
              >
                <Hammer className="h-4 w-4" /> Stages
              </button>
              <button
              ...
              >
                <Shuffle className="h-4 w-4" /> Daily
              </button>
              <button
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <button
                  ...
                  title={
                    view === 'settings' ? 'Open creator code' : 'Creator mark'
                  }
                >
                  made by tbam
                </button>
              ...
              <div className="absolute left-20 top-14 z-50 w-72 rounded-3xl border border-orange-400/30 bg-zinc-950 p-3 shadow-2xl shadow-black/60">
                <div className="mb-2 px-3 py-2">
                  ...
                  <p className="mt-1 text-sm text-zinc-500">
                    Dashboard content changes to the selected subject.
                  </p>
                </div>
                {visibleSubjects.map((subject) => {
                  const Icon = subject.icon;
                  const subjectUnlocked = subject.topics.filter(
                    (topic) => unlocked[topic.id]
                  ).length;
                  ...
                  return (
                    <button
                      ...
                      className={`flex w-full items-center gap-3 rounded-2xl p-3 text-left transition ${
                        isSelected
                          ? activeTheme.soft + ' ' + activeTheme.accent
                          : 'text-zinc-300 hover:bg-zinc-900'
                      }`}
                    >
                      <div
                        className={`rounded-xl p-2 ${
                          isSelected ? activeTheme.soft : 'bg-zinc-900'
                        }`}
                      >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-500">
                          {subjectUnlocked}/{subject.topics.length} stages
                          unlocked
                        </p>
                      </div>
                    </button>
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8">
          <section className="grid gap-5 md:grid-cols-[1.3fr_0.7fr] md:items-center">
                ...
                {view === 'stages' ? (
                  <span className="inline-flex items-center gap-3">
                    {activeThemeId === 'cyber' ? (
                      <span className="cyber-gameboy-clock">
                        ...
                        <span className="cyber-gameboy-screen">
                          <span className="cyber-gameboy-label">
                            REVISION OS
                          </span>
                          <span className="cyber-gameboy-time">
                    ...
                    <span className="flex flex-col leading-none">
                      <span className="text-[10px] uppercase tracking-[0.22em] text-orange-200/80">
                        Revision clock
                      </span>
            ...
            <div
              className={`rounded-3xl border border-zinc-800 ${activeTheme.panel} p-5 shadow-2xl shadow-orange-950/20`}
            >
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-black text-white">
                    {unlockedCount}/{allTopics.length}
                  </h2>
                  <p className="mt-2 text-sm text-zinc-400">
                    Total stages unlocked.
                  </p>
                </div>
          ...
          {view === 'home' && (
            <section className="mt-6 space-y-6">
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                {(() => {
                  ...
                  const recall = Math.round(
                    (subjectUnlocked / subject.topics.length) * 100
                  );
                  return (
                    <button
                      key={subject.id}
                      ...
                      <div className="flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            >
                              <label className="mb-2 block text-xs font-black uppercase tracking-[0.24em] text-pink-100/90">
                                Section
                              </label>
                              <select
                                value={selectedSection}
                            ...
                            <p className="mt-1 max-w-xs text-sm leading-6 text-zinc-400">
                              {subject.description}
                            </p>
                            <p className="mt-3 text-sm font-black text-orange-200">
                              {subjectUnlocked}/{subject.topics.length} stages
                              unlocked
                            </p>
                          </div>
                ...
                <div className="min-h-[190px] rounded-3xl border border-zinc-800 bg-zinc-900 p-5">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <button
                      onClick={() => setView('themes')}
                      className="rounded-2xl border border-orange-400/40 px-4 py-2 text-sm font-black text-orange-200 hover:bg-orange-400/10"
                    >
                      View -
                    </button>
                  </div>
              ...
              <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
                <button
                  onClick={startDailyTest}
                  className="rounded-3xl border border-zinc-800 bg-zinc-900 p-5 text-left transition hover:bg-zinc-800 active:scale-[0.99]"
                >
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() => setView('general')}
                  className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-zinc-900 p-5 text-left transition hover:bg-zinc-800 active:scale-[0.99]"
                >
                  <div className="relative z-10">
                    <div className="flex items-center gap-2">
                    ...
                    <p className="mt-2 max-w-md text-sm leading-6 text-zinc-400">
                      Browse notes, key concepts and explanations across the
                      whole subject before you test.
                    </p>
                    <div className="mt-4 inline-flex rounded-2xl border border-orange-400/40 px-4 py-2 text-sm font-black text-orange-200">
                      Explore Notes -
                    </div>
                  </div>
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-400">
                      Focused learning. One stage at a time.
                    </p>
                  </div>
                  <button
                    onClick={goToStages}
                      ...
                      <button
                        ...
                        className={`rounded-2xl border p-4 text-left transition active:scale-[0.99] ${
                          isLocked
                            ...
                            : activeTheme.border + ' ' + activeTheme.soft
                        }`}
                      >
                          ...
                          <div
                            className={`flex h-10 w-10 items-center justify-center rounded-xl border ${
                              isLocked
                                ...
                                : activeTheme.border + ' ' + activeTheme.accent
                            }`}
                          >
                            {index + 1}
                          </div>
          ...
          {view === 'general' && (
            <section className="mt-6">
              <GeneralHub
                ...
                sections={sectionGeneralContent}
              />
            </section>
          )}
          ...
          {(view === 'stages' || view === 'topic' || view === 'daily') && (
            <section className="mt-6 grid gap-6 lg:grid-cols-[0.75fr_1.25fr]">
              <aside
                className={`${
                  view !== 'stages' ? 'hidden lg:block' : 'block'
                } space-y-4`}
              >
                ...
                <button
                  onClick={startDailyTest}
                  className="w-full rounded-3xl border border-orange-400/40 bg-orange-400/10 p-5 text-left transition hover:bg-orange-400/15 active:scale-[0.99]"
                >
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-2 text-sm text-zinc-500">
                            {isLocked
                              ? 'Locked — forge the stage before it'
                              : 'Tap to open test'}
                          </p>
                        </div>
                        {isLocked ? (
              ...
              <main
                className={`${view === 'stages' ? 'hidden lg:block' : 'block'}`}
              >
                {view === 'topic' && (
                  <div className="grid gap-6 xl:grid-cols-2">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <div className="flex rounded-2xl border border-zinc-800 bg-zinc-950 p-1">
                          <button
                            ...
                            title={
                              !submitted
                                ? 'Notes unlock after you click Strike the Anvil.'
                                : 'Open notes'
                            }
                          >
                            Notes
                      ...
                      {stageTab === 'notes' && submitted ? (
                        <div className="mt-5 space-y-3">
                          {selectedTopic.notes.map((note, index) => (
                            ...
                            >
                              <span className="mr-2 font-black text-orange-400">
                                {index + 1}.
                              </span>
                              {note}
                            </div>
                        ...
                        <div className="mt-5 rounded-2xl border border-zinc-800 bg-zinc-950 p-4 text-zinc-300">
                          Notes are locked while the test is active. Click
                          Strike the Anvil to mark your answers and unlock the
                          notes.
                        </div>
                      )}
                    </div>
                    ...
                    <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-5 md:p-6">
                      ...
                      <div className="mt-5 flex flex-wrap gap-3">
                        <button
                          onClick={submitQuiz}
                          className={`rounded-2xl px-5 py-3 font-bold text-white active:scale-[0.99] ${activeTheme.button}`}
                        >
                          Strike the Anvil
                        </button>
                        <button
                          onClick={resetQuiz}
                          className="inline-flex items-center rounded-2xl border border-zinc-700 bg-zinc-900 px-5 py-3 font-bold text-zinc-100 hover:bg-zinc-800 active:scale-[0.99]"
                        >
                      ...
                      {submitted && !passed && (
                        <div className="mt-4 rounded-2xl border border-red-500/30 bg-red-500/10 p-4 text-sm font-semibold text-red-200">
                          Not forged yet. You need 100%. Re-read the notes and
                          retry.
                        </div>
                      )}
                      {passed && (
                        <div className="mt-4 rounded-2xl border border-green-500/30 bg-green-500/10 p-4 text-sm font-semibold text-green-200">
                          <div className="flex items-center gap-2">
                            <Trophy className="h-5 w-5" /> Stage forged. Next
                            stage unlocked.
                          </div>
                        </div>
                      )}
                ...
                {view === 'daily' && (
                  <div className="rounded-3xl border border-zinc-800 bg-zinc-900 p-5 md:p-6">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <Shuffle className="h-6 w-6 text-orange-400" />
                          <h2 className="text-2xl font-black text-white">
                            Daily {selectedSubject.title} Test
                          </h2>
                        </div>
                        <p className="mt-2 text-sm text-zinc-400">
                      ...
                      <ProgressRing
                        value={dailySubmitted ? dailyScore : recallPercentage}
                        label={dailySubmitted ? 'Score' : 'Recall'}
                      />
                    </div>
                    ...
                    <div className="mt-5 flex flex-wrap gap-3">
                      <button
                        onClick={() => setDailySubmitted(true)}
                        className={`rounded-2xl px-5 py-3 font-bold text-white active:scale-[0.99] ${activeTheme.button}`}
                      >
                        Mark Daily Test
                      </button>
                    ...
                    {dailySubmitted && (
                      <div className="mt-4 rounded-2xl border border-orange-500/30 bg-orange-500/10 p-4 text-sm font-semibold text-orange-100">
                        Daily recall score: {dailyScore}%. Keep pushing it
                        towards 100%.
                      </div>
                    )}
                  </div>
                ...
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-4xl font-black text-white">
                      {selectedSubject.title} Super Test
                    </h2>
                    <p className="mt-2 max-w-2xl text-zinc-400">
                      This is the written-answer test for the whole subject.
                      Write your answers properly, then submit to compare them
                      with the suggested answers.
                    </p>
                  </div>
                  <button
                    onClick={() => setView('stages')}
                    className="rounded-2xl border border-zinc-700 bg-zinc-950 px-5 py-3 font-bold text-zinc-200 hover:bg-zinc-800"
                  >
                    Back to stages
                  </button>
                </div>
                  ...
                  {superTestQuestions.map((question, index) => (
                    ...
                    >
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <p className="rounded-full border border-zinc-800 bg-zinc-900 px-3 py-1 text-xs font-bold text-zinc-400">
                          {question.topicTitle}
                        </p>
                      </div>
                      ...
                      {superTestSubmitted && (
                        <div
                          className={`mt-4 rounded-2xl border p-4 ${
                            isBroadAnswerCorrect(
                              question,
                              superTestAnswers[index]
                            )
                  ...
                  {!superTestSubmitted ? (
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-zinc-400">
                          After submitting, you need 100% before the subject
                          reset unlocks.
                        </p>
                      </div>
                      <button
                        onClick={() => setSuperTestSubmitted(true)}
                        className="rounded-2xl bg-orange-500 px-6 py-3 font-black text-white hover:bg-orange-600"
                      >
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div>
                        <h3 className="text-2xl font-black text-white">
                          Super Test score: {superTestScore}%
                        </h3>
                        <p className="mt-1 text-sm text-zinc-400">
                          {superTestPassed
                            ? '100% earned. You can now reset this subject and re-forge it from the beginning.'
                            : 'Reset is locked. You need 100% on the Super Test first.'}
                        </p>
                      </div>
                      <div className="flex flex-wrap gap-3">
                        {!superTestPassed && (
                          ...
                          >
                            <RotateCcw className="mr-2 h-4 w-4" /> Retry Super
                            Test
                          </button>
                        )}
                        <button
              ...
              <div className="rounded-3xl border border-zinc-800 bg-zinc-900/80 p-6 shadow-2xl shadow-black/20">
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 max-w-2xl text-zinc-400">
                      Change your revision timer and progress saving settings.
                    </p>
                  </div>
                ...
                <div className="mt-8 grid gap-5 lg:grid-cols-2">
                  <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
                    ...
                    <div className="mt-5 grid gap-4 sm:grid-cols-2">
                      <label className="block">
                        ...
                        <input
                          ...
                          className="mt-2 w-full rounded-2xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-white outline-none focus:border-orange-400"
                        />
                      </label>
                      <label className="block">
                        <span className="text-xs font-bold uppercase tracking-widest text-orange-300">
                    ...
                    <button
                      onClick={() => {
                        setRevisionSeconds(0);
                        setLastBreakMarker(0);
                        setBreakAlarm(false);
                        unlockThemeAction('revisionClockReset');
                      }}
                      className="mt-5 rounded-2xl border border-zinc-700 bg-zinc-900 px-5 py-3 font-bold text-zinc-200 hover:bg-zinc-800"
                    >
                  ...
                  <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-5">
                    ...
                    <p className="mt-2 text-sm text-zinc-400">
                      {saveEnabled
                        ? `This device is saving progress as ${
                            username || 'Student'
                          }.`
                        : 'Progress is not currently being saved on this device.'}
                    </p>
